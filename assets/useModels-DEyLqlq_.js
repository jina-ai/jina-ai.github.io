import{k as z,l as j,m as o}from"./index-CWkEFhZt.js";const M=`---
...
To effectively deploy Reader LM 1.5B, organizations should focus on scenarios involving complex HTML document processing where accuracy and efficiency are paramount. The model requires CUDA-capable GPU infrastructure for optimal performance, though its efficient architecture means it can run effectively on more modest hardware compared to larger alternatives. For production deployments, the model is available through both AWS SageMaker and Azure Marketplace, offering flexible integration options. While the model excels at HTML-to-markdown conversion, it's important to note that it's specifically optimized for this task and may not be suitable for general-purpose text generation or other NLP tasks. When processing extremely long documents (approaching 512K tokens), users should be aware that performance might degrade as this exceeds the model's training parameters. For optimal results, implement the provided repetition detection mechanisms and consider using contrastive search during inference to maintain output quality.
`;function Y(){const a=z([]),v=(n,l)=>{const[h,g,...c]=n.split("---"),e={};let t=null,u=!1,d=!1,s={};if(g.split(`
`).forEach(x=>{const r=x.trim();if(!(!r||r.startsWith("#"))){if(r.startsWith("- ")){const i=r.substring(2);d&&t==="metrics"?i.startsWith("name:")?(Object.keys(s).length>0&&(e.metrics=e.metrics||[]).push(s),s={name:i.substring(5).trim()}):i.startsWith("value:")&&(s.value=parseFloat(i.substring(6).trim())||i.substring(6).trim()):t&&(Array.isArray(e[t])||(e[t]=[]),e[t].push(i));return}if(r.includes(":")){const[i,...T]=r.split(":"),m=i.trim(),f=T.join(":").trim();t=m,u=f==="",d=m==="metrics",!u&&!d?e[m]=f.replace(/^["'](.*)["']$/,"$1"):u&&(e[m]=[])}}}),d&&Object.keys(s).length>0&&(e.metrics=e.metrics||[]).push(s),!e.model_name||!e.model_version||!e.model_type||!e.organization||!e.license||!e.tags)throw new Error(`Missing required metadata fields in model ${l}`);const p={model_name:e.model_name,model_version:e.model_version,model_type:e.model_type,organization:e.organization,license:e.license,token_length:e.token_length,image_size:e.image_size,tags:e.tags||[],diagrams:e.diagrams||[],input_type:e.input_type||[],output_type:e.output_type||[],architecture:e.architecture,parameter_size:e.parameter_size,training_data:e.training_data,input_format:e.input_format,output_dimension:e.output_dimension,language:e.language||[],metrics:e.metrics,quantization:e.quantization,intended_use:e.intended_use,limitations:e.limitations,ethical_considerations:e.ethical_considerations,hardware_requirements:e.hardware_requirements,api_type:e.api_type,api_link:e.api_link,aws:e.aws,release_blog:e.release_blog,deprecated_by:e.deprecated_by,related_models:e.related_models,arxiv:e.arxiv,huggingface:e.huggingface,endpoints:e.endpoints||[],release_date:e.release_date,availability:e.availability||[]};return{slug:l,name:p.model_name,metadata:p,content:c.join("---").trim()}};j(async()=>{try{const n=Object.assign({"../content/models/ReaderLM-v2.md":M,"../content/models/jina-clip-v1.md":q,"../content/models/jina-clip-v2.md":A,"../content/models/jina-colbert-v1-en.md":E,"../content/models/jina-colbert-v2.md":I,"../content/models/jina-embedding-b-en-v1.md":C,"../content/models/jina-embeddings-v2-base-code.md":B,"../content/models/jina-embeddings-v2-base-de.md":L,"../content/models/jina-embeddings-v2-base-en.md":R,"../content/models/jina-embeddings-v2-base-es.md":G,"../content/models/jina-embeddings-v2-base-zh.md":P,"../content/models/jina-embeddings-v3.md":J,"../content/models/jina-embeddings-v4.md":W,"../content/models/jina-reranker-m0.md":S,"../content/models/jina-reranker-v1-base-en.md":O,"../content/models/jina-reranker-v1-tiny-en.md":F,"../content/models/jina-reranker-v1-turbo-en.md":U,"../content/models/jina-reranker-v2-base-multilingual.md":K,"../content/models/reader-lm-0.5b.md":H,"../content/models/reader-lm-1.5b.md":D});a.value=Object.entries(n).map(([l,h])=>{var c;const g=((c=l.split("/").pop())==null?void 0:c.replace(".md",""))||"";return v(h,g)})}catch(n){console.error("Error loading model files:",n),a.value=[]}});const b=o(()=>a.value.find(n=>n.name==="jina-reranker-v2-base-multilingual")),y=o(()=>a.value.find(n=>n.name==="jina-clip-v1")),w=o(()=>a.value.find(n=>n.name==="jina-clip-v2")),k=o(()=>a.value.find(n=>n.name==="jina-embeddings-v4")),_=o(()=>a.value.find(n=>n.name==="jina-reranker-m0"));return{models:a,jinaRerankerMultilingual:b,clipV1:y,clipV2:w,defaultEmbeddingModel:k,jinaRerankerMultiModal:_}}export{Y as u};
