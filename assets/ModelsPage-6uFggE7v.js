import{s as be,br as ye,bs as we,p as ke,k as _,W as de,j as _e,u as xe,ao as te,ag as Te,w as se,m as H,a_ as oe,a$ as ze,aT as qe,aU as Me,aR as je,aq as Ae,ap as Ce,n as Ie,V as re,bl as Ee,bm as Be,bn as Le,bt as Se,a1 as Re,a2 as o,a3 as g,a4 as a,a5 as t,a7 as h,ac as d,ae as v,T as Pe,ab as b,al as u,ad as r,aj as O,ak as k,as as Ge,b2 as Je,be as Oe,a9 as L,a8 as I,q as V,a6 as X,af as We,aa as le,bj as Fe,aP as Ue,aC as Ne}from"./index-B5Fh9r6K.js";import{a as ce,b as Z,d as W}from"./QItemLabel-CXCJobFC.js";import{Q as De}from"./QBtnDropdown-CoySmqDg.js";import{Q as He}from"./QBanner-C09wgPhh.js";import{Q}from"./QTooltip-fHZa1qRv.js";import{Q as Qe}from"./QPage-J885n2uS.js";import{e as Ke}from"./date-mo3JZ7C_.js";import{E as Ve}from"./EmbeddingGraph-BV7jgoWB.js";import{H as Ye}from"./H2TitleBlock-CDWwZTEK.js";import{R as Xe}from"./ResearchersComponent-CHDWCCPZ.js";import{N as Ze}from"./NewsFilterComponent-CarDM7oT.js";import{u as $e}from"./blogs-DDmd2Vqj.js";import"./QMenu-BxQorple.js";import"./position-engine-RkQiaHBi.js";import"./QLinearProgress-7qGL4Axr.js";import"./embedding-DqzJvN10.js";import"./search-DedqCNEq.js";import"./orderBy-Btahtffh.js";import"./QSelect-BFbqs_aT.js";import"./NewsVerticalCard-Bd3xdZ81.js";import"./SXTooltip-CgG5CV4i.js";const en='<circle cx="15" cy="15" r="15"><animate attributeName="r" from="15" to="15" begin="0s" dur="0.8s" values="15;9;15" calcMode="linear" repeatCount="indefinite"></animate><animate attributeName="fill-opacity" from="1" to="1" begin="0s" dur="0.8s" values="1;.5;1" calcMode="linear" repeatCount="indefinite"></animate></circle><circle cx="60" cy="15" r="9" fill-opacity=".3"><animate attributeName="r" from="9" to="9" begin="0s" dur="0.8s" values="9;15;9" calcMode="linear" repeatCount="indefinite"></animate><animate attributeName="fill-opacity" from=".5" to=".5" begin="0s" dur="0.8s" values=".5;1;.5" calcMode="linear" repeatCount="indefinite"></animate></circle><circle cx="105" cy="15" r="15"><animate attributeName="r" from="15" to="15" begin="0s" dur="0.8s" values="15;9;15" calcMode="linear" repeatCount="indefinite"></animate><animate attributeName="fill-opacity" from="1" to="1" begin="0s" dur="0.8s" values="1;.5;1" calcMode="linear" repeatCount="indefinite"></animate></circle>',nn=be({name:"QSpinnerDots",props:ye,setup(E){const{cSize:m,classes:y}=we(E);return()=>ke("svg",{class:y.value,fill:"currentColor",width:m.value,height:m.value,viewBox:"0 0 120 30",xmlns:"http://www.w3.org/2000/svg",innerHTML:en})}}),an=`---
...
`;function wn(){const E=_([]),m=(y,e)=>{const[S,R,...A]=y.split("---"),n={};let c=null,q=!1,P=!1,x={};if(R.split(`
`).forEach(U=>{const T=U.trim();if(!(!T||T.startsWith("#"))){if(T.startsWith("- ")){const f=T.substring(2);P&&c==="metrics"?f.startsWith("name:")?(Object.keys(x).length>0&&(n.metrics=n.metrics||[]).push(x),x={name:f.substring(5).trim()}):f.startsWith("value:")&&(x.value=parseFloat(f.substring(6).trim())||f.substring(6).trim()):c&&(Array.isArray(n[c])||(n[c]=[]),n[c].push(f));return}if(T.includes(":")){const[f,...G]=T.split(":"),w=f.trim(),p=G.join(":").trim();c=w,q=p==="",P=w==="metrics",!q&&!P?n[w]=p.replace(/^["'](.*)["']$/,"$1"):q&&(n[w]=[])}}}),P&&Object.keys(x).length>0&&(n.metrics=n.metrics||[]).push(x),!n.model_name||!n.model_version||!n.model_type||!n.organization||!n.license||!n.tags)throw new Error(`Missing required metadata fields in model ${e}`);const F={model_name:n.model_name,model_version:n.model_version,model_type:n.model_type,organization:n.organization,license:n.license,token_length:n.token_length,image_size:n.image_size,tags:n.tags||[],architecture:n.architecture,parameter_size:n.parameter_size,training_data:n.training_data,input_format:n.input_format,output_dimension:n.output_dimension,language:n.language||[],metrics:n.metrics,quantization:n.quantization,intended_use:n.intended_use,limitations:n.limitations,ethical_considerations:n.ethical_considerations,hardware_requirements:n.hardware_requirements,api_type:n.api_type,api_link:n.api_link,aws:n.aws,release_blog:n.release_blog,deprecated_by:n.deprecated_by,related_models:n.related_models,arxiv:n.arxiv,huggingface:n.huggingface,endpoints:n.endpoints||[],release_date:n.release_date,availability:n.availability||[]};return{slug:e,name:F.model_name,metadata:F,content:A.join("---").trim()}};return de(async()=>{try{const y=Object.assign({"../content/models/jina-clip-v1.md":an,"../content/models/jina-clip-v2.md":tn,"../content/models/jina-colbert-v1-en.md":sn,"../content/models/jina-colbert-v2.md":on,"../content/models/jina-embedding-b-en-v1.md":rn,"../content/models/jina-embeddings-v2-base-code.md":ln,"../content/models/jina-embeddings-v2-base-de.md":cn,"../content/models/jina-embeddings-v2-base-en.md":dn,"../content/models/jina-embeddings-v2-base-es.md":mn,"../content/models/jina-embeddings-v2-base-zh.md":gn,"../content/models/jina-embeddings-v3.md":un,"../content/models/jina-reranker-v1-base-en.md":hn,"../content/models/jina-reranker-v1-tiny-en.md":pn,"../content/models/jina-reranker-v1-turbo-en.md":fn,"../content/models/jina-reranker-v2-base-multilingual.md":vn,"../content/models/reader-lm-0.5b.md":bn,"../content/models/reader-lm-1.5b.md":yn});E.value=Object.entries(y).map(([e,S])=>{var A;const R=((A=e.split("/").pop())==null?void 0:A.replace(".md",""))||"";return m(S,R)})}catch(y){console.error("Error loading model files:",y),E.value=[]}}),{models:E}}const kn=_e({__name:"ModelsPage",setup(E,{expose:m}){m();const y=xe(),e=$e(),{settings:S}=te(y),{featuredBlogs:R,authors:A,translatedAllBlogs:n,accessedAt:c,lastAccessedAt:q,initiating:P}=te(e),x=_(""),F=_(""),U=_(!1),T=_(null),f=_(!1),G=_("release_date"),w=_("desc"),p=_(null),{models:B}=wn(),M=_([]),K=_(!1),N=Ae(),$=Ce(),{t:C}=Te({useScope:"global"}),me=Ie();se(B,i=>{i&&i.length>0&&!K.value&&(M.value=i.concat(),K.value=!0,re(()=>{D()}))},{immediate:!0}),se([G,w],()=>{K.value&&M.value.length>0&&re(()=>{D()})},{deep:!0});const Y=i=>{if(!i)return 0;const s=i.toUpperCase(),l=parseFloat(s);return isNaN(l)?0:s.endsWith("B")?l*1e9:s.endsWith("M")?l*1e6:l},ge=H(()=>ee.value.filter(i=>{var s,l;return(l=(s=p.value)==null?void 0:s.metadata.availability)==null?void 0:l.includes(i.key)})),ue=H(()=>["parameter_size","token_length","image_size","output_dimension"].filter(s=>{var l,z;return(z=(l=p.value)==null?void 0:l.metadata)==null?void 0:z[s]}).map(s=>({key:s,value:p.value.metadata[s]}))),he=i=>{var s;return i==="en"?C("tokenizer.english"):i==="zh"?C("tokenizer.chinese"):i==="multilingual"?C("embedding.multilingual"):(s=S.value.localeOptions.find(l=>l.value===i))==null?void 0:s.label},D=()=>{if(!x.value)M.value=B.value.concat();else{const i=x.value.toLowerCase().trim();f.value=!0,M.value=B.value.filter(s=>!!(s.name.toLowerCase().includes(i)||s.metadata.tags.some(l=>l.toLowerCase().includes(i))||s.metadata.model_type.toLowerCase().includes(i)||s.metadata.organization.toLowerCase().includes(i))),f.value=!1}switch(G.value){case"name":M.value.sort((i,s)=>{const l=i.name.localeCompare(s.name);return w.value==="asc"?l:-l});break;case"release_date":M.value.sort((i,s)=>{const l=new Date(i.metadata.release_date||"0").valueOf(),z=new Date(s.metadata.release_date||"0").valueOf(),j=l-z;return w.value==="asc"?j:-j});break;case"parameter_size":M.value.sort((i,s)=>{const l=Y(i.metadata.parameter_size||"0"),z=Y(s.metadata.parameter_size||"0"),j=l-z;return w.value==="asc"?j:-j});break}},pe=i=>{G.value=i,D()};oe(()=>{w.value&&D()});const J=H(()=>{var i;return(i=p.value)==null?void 0:i.metadata.model_name}),ee=H(()=>[{type:"license_link",icon:"img:/J.svg",key:"license",link:"/api-dashboard/license-config?login=true"},{type:"api_link",icon:"img:/J.svg",key:"api",link:`/?sui&model=${J.value}`},{type:"aws_link",icon:`img:${Ee}`,key:"aws",link:"https://aws.amazon.com/marketplace/seller-profile?id=seller-stch2ludm6vgy"},{type:"azure_link",icon:`img:${Be}`,key:"azure",link:"https://azuremarketplace.microsoft.com/en-US/marketplace/apps?page=1&search=jina"},{type:"gcp_link",icon:`img:${Le}`,key:"gcp",link:"https://console.cloud.google.com/marketplace/browse?q=jina"},{type:"huggingface_link",icon:"img:/huggingface_logo.svg",key:"huggingface",link:`https://huggingface.co/jinaai/${J.value}`}]),ne=async i=>{try{U.value=!0,T.value=null,F.value=i,B.value.length===0&&await new Promise(l=>setTimeout(l,1e3));const s=B.value.find(l=>l.slug===i);if(!s)throw new Error(`Model "${i}" not found`);p.value=s,N.params.slug!==i&&$.push(`/models/${i}`)}catch(s){T.value=s instanceof Error?s.message:"Failed to load model",p.value=null}finally{U.value=!1}},fe=i=>({"margin-top":`${i}px`}),ve=H(()=>N.params.slug===void 0),ae=()=>{let i=C("model_graph.title"),s=C("model_graph.description"),l="https://jina.ai/banner-models.png",z="Jina AI",j="https://jina.ai/models";N.name==="model-detail"&&p.value&&(i=C("models.title",{_modelName:J.value}),s=C(`embedding.${J.value.replace(".","")}_description`),l=`https://jina.ai/models-banner/${J.value}.png`,z=p.value.metadata.organization,j=`https://jina.ai/models/${p.value.slug}`),Se({title:i,meta:[{name:"title",content:i},{name:"description",content:s},{name:"author",content:z},{property:"og:title",content:i},{property:"og:url",content:j},{property:"og:image",content:l},{property:"og:description",content:s},{property:"twitter:title",content:i},{property:"twitter:url",content:j},{property:"twitter:image",content:l},{property:"twitter:description",content:s},{property:"twitter:label1",content:"Created by"},{property:"twitter:data1",content:z}]})};oe(()=>{const i=N.params.slug;i&&ne(i),ae()}),de(()=>{M.value=B.value.concat()});const ie={userStore:y,newsStore:e,settings:S,featuredBlogs:R,authors:A,translatedAllBlogs:n,accessedAt:c,lastAccessedAt:q,initiating:P,searchQuery:x,currentSlug:F,isLoading:U,error:T,isSearching:f,sortOption:G,sortDirection:w,selectedModel:p,models:B,filteredModels:M,isInitialized:K,route:N,router:$,t:C,$q:me,parseParameterSize:Y,availableExternalLinks:ge,modelDetails:ue,mapLangCodeToLanguageName:he,applySearchAndSort:D,setSortOption:pe,selectModelName:J,externalLinks:ee,selectModel:ne,getStyle:fe,showModelGraph:ve,initHead:ae,get langcode2SingleEmoji(){return Ke},get ccncOptions(){return ze},get embeddingIcon(){return qe},get rerankerIcon(){return Me},get readerIcon(){return je},EmbeddingGraph:Ve,H2TitleBlock:Ye,ResearchersComponent:Xe,NewsFilterComponent:Ze};return Object.defineProperty(ie,"__isScriptSetup",{enumerable:!1,value:!0}),ie}}),_n={key:0,class:"q-pa-xl row justify-center overflow-hidden q-mb-xl"},xn={class:"col-12 col-sm-11 col-md-10",style:{"z-index":"1"}},Tn={class:"col-12 col-md-3 col-xl-2 q-pa-md models-sidebar"},zn={class:"row q-gutter-sm items-center q-mb-md"},qn={key:1,class:"text-center q-pa-md text-grey-7"},Mn={class:"col-md-8 col-lg-7 col-xl-6 q-pa-md"},jn={key:0,class:"text-center q-pa-xl"},An={class:"text-dim q-mt-sm"},Cn={key:1,class:"text-center q-pa-xl"},In={class:"text-negative q-mt-sm"},En={class:"row justify-between"},Bn={class:"model-title"},Ln={class:"row justify-between items-center"},Sn={class:"col q-mr-md"},Rn={class:"row items-center"},Pn={class:"text-caption text-dim q-mr-sm"},Gn={class:"row items-center"},Jn={class:"text-caption text-dim q-mr-sm"},On={class:"row items-center"},Wn={class:"text-caption text-dim q-mr-sm"},Fn={key:0,class:"row items-center"},Un={class:"text-caption text-dim q-mr-sm"},Nn={key:1,class:"row items-center"},Dn={class:"text-caption text-dim q-mr-sm"},Hn={class:"row items-center"},Qn={class:"text-caption text-dim q-mr-sm"},Kn={class:"col-12 text-caption text-dim q-mr-sm"},Vn={class:"text-r-h4 q-mt-xl q-mb-md"},Yn={key:3,class:"text-center q-pa-xl q-ma-xl text-dim"};function Xn(E,m,y,e,S,R){const A=Fe("q-markdown");return o(),g(Qe,{class:"no-wrap","style-fn":e.getStyle},{default:a(()=>[t(Pe,{appear:"","enter-active-class":"animated slower fadeIn","leave-active-class":"animated faster fadeOut"},{default:a(()=>[e.showModelGraph?(o(),h("div",_n,[d("div",xn,[t(e.H2TitleBlock,{title:"model_graph.title",anchor:"models",subtitle:"model_graph.description"}),t(e.EmbeddingGraph)])])):v("",!0)]),_:1}),d("div",{class:le(e.$q.screen.lt.md?"column is-vertical":"row justify-center"),id:"catalog"},[d("div",Tn,[d("div",zn,[t(Je,{modelValue:e.searchQuery,"onUpdate:modelValue":[m[5]||(m[5]=n=>e.searchQuery=n),e.applySearchAndSort],filled:"",square:"",loading:e.isSearching,placeholder:e.t("models.search.placeholder"),class:"col",clearable:"",debounce:"300"},{prepend:a(()=>[t(b,{name:"search"})]),after:a(()=>[t(De,{stretch:"",flat:"",square:"",label:e.t(`models.sort.${e.sortOption}`),"no-caps":"","no-wrap":""},{default:a(()=>[t(ce,null,{default:a(()=>[t(Z,{header:""},{default:a(()=>[u(r(e.t("models.sort.label")),1)]),_:1}),t(O,{clickable:"",onClick:m[0]||(m[0]=n=>e.setSortOption("name")),active:e.sortOption==="name"},{default:a(()=>[t(k,null,{default:a(()=>[u(r(e.t("models.sort.name")),1)]),_:1}),e.sortOption==="name"?(o(),g(k,{key:0,side:""},{default:a(()=>[t(b,{name:"check"})]),_:1})):v("",!0)]),_:1},8,["active"]),t(O,{clickable:"",onClick:m[1]||(m[1]=n=>e.setSortOption("release_date")),active:e.sortOption==="release_date"},{default:a(()=>[t(k,null,{default:a(()=>[u(r(e.t("models.sort.release_date")),1)]),_:1}),e.sortOption==="release_date"?(o(),g(k,{key:0,side:""},{default:a(()=>[t(b,{name:"check"})]),_:1})):v("",!0)]),_:1},8,["active"]),t(O,{clickable:"",onClick:m[2]||(m[2]=n=>e.setSortOption("parameter_size")),active:e.sortOption==="parameter_size"},{default:a(()=>[t(k,null,{default:a(()=>[u(r(e.t("models.sort.parameter_size")),1)]),_:1}),e.sortOption==="parameter_size"?(o(),g(k,{key:0,side:""},{default:a(()=>[t(b,{name:"check"})]),_:1})):v("",!0)]),_:1},8,["active"]),t(Ge),t(Z,{header:""},{default:a(()=>[u(r(e.t("models.sort.direction.name")),1)]),_:1}),t(O,{clickable:"",onClick:m[3]||(m[3]=n=>e.sortDirection="asc"),active:e.sortDirection==="asc"},{default:a(()=>[t(k,null,{default:a(()=>[u(r(e.t("models.sort.direction.asc")),1)]),_:1}),e.sortDirection==="asc"?(o(),g(k,{key:0,side:""},{default:a(()=>[t(b,{name:"check"})]),_:1})):v("",!0)]),_:1},8,["active"]),t(O,{clickable:"",onClick:m[4]||(m[4]=n=>e.sortDirection="desc"),active:e.sortDirection==="desc"},{default:a(()=>[t(k,null,{default:a(()=>[u(r(e.t("models.sort.direction.desc")),1)]),_:1}),e.sortDirection==="desc"?(o(),g(k,{key:0,side:""},{default:a(()=>[t(b,{name:"check"})]),_:1})):v("",!0)]),_:1},8,["active"])]),_:1})]),_:1},8,["label"])]),_:1},8,["modelValue","loading","placeholder"])]),t(ce,{class:"overflow-auto models-list"},{default:a(()=>[e.filteredModels.length?(o(),g(Oe,{key:0,name:"list2"},{default:a(()=>[(o(!0),h(I,null,L(e.filteredModels,n=>Ue((o(),g(O,{key:n.slug,clickable:"",active:e.currentSlug===n.slug,class:le(e.currentSlug===n.slug?"text-primary":"text-dim"),onClick:c=>e.selectModel(n.slug)},{default:a(()=>[t(k,null,{default:a(()=>[t(Z,null,{default:a(()=>[u(r(n.name),1)]),_:2},1024)]),_:2},1024)]),_:2},1032,["active","class","onClick"])),[[Ne]])),128))]),_:1})):(o(),h("div",qn,r(e.t("models.search.no_results",{query:e.searchQuery})),1))]),_:1})]),d("div",Mn,[e.isLoading?(o(),h("div",jn,[t(nn,{color:"primary",size:"40"}),d("div",An,r(e.t("models.loading")),1)])):e.error?(o(),h("div",Cn,[t(b,{name:"error_outline",color:"negative",size:"40px"}),d("div",In,r(e.error),1),t(V,{flat:"",color:"primary",label:e.t("models.back_to_models"),class:"q-mt-md",onClick:m[6]||(m[6]=n=>e.router.push("/models"))},null,8,["label"])])):e.selectedModel?(o(),h(I,{key:2},[e.selectedModel.metadata.deprecated_by?(o(),g(He,{key:0,dense:"",class:"bg-warning text-black ellipsis","inline-actions":""},{avatar:a(()=>[t(b,{name:"warning"})]),action:a(()=>[(o(!0),h(I,null,L(e.selectedModel.metadata.deprecated_by,n=>(o(),g(V,{flat:"","text-color":"black",size:"sm",square:"","no-caps":"",key:n,color:"white",label:n,icon:"link",onClick:c=>e.selectModel(n)},null,8,["label","onClick"]))),128))]),default:a(()=>[u(" "+r(e.t("models.warnings.deprecated"))+" ",1)]),_:1})):v("",!0),t(We,{flat:"",square:"",class:"metadata-section bg-mixed-100 q-mb-xl q-pa-md"},{default:a(()=>[t(X,null,{default:a(()=>{var n,c,q;return[d("div",En,[d("div",null,[(n=e.selectedModel.metadata.endpoints)!=null&&n.includes("embedding")?(o(),g(b,{key:0,class:"info-icon",name:"img:"+e.embeddingIcon},{default:a(()=>[t(Q,null,{default:a(()=>[u(r(e.t("landing_page.embeddings")),1)]),_:1})]),_:1},8,["name"])):(c=e.selectedModel.metadata.endpoints)!=null&&c.includes("rank")?(o(),g(b,{key:1,class:"info-icon",name:"img:"+e.rerankerIcon},{default:a(()=>[t(Q,null,{default:a(()=>[u(r(e.t("landing_page.reranker")),1)]),_:1})]),_:1},8,["name"])):(q=e.selectedModel.metadata.endpoints)!=null&&q.includes("read")?(o(),g(b,{key:2,class:"info-icon",name:"img:"+e.readerIcon},{default:a(()=>[t(Q,null,{default:a(()=>[u(r(e.t("landing_page.reader")),1)]),_:1})]),_:1},8,["name"])):v("",!0),e.ccncOptions.includes(e.selectModelName)?(o(),g(b,{key:3,class:"info-icon",name:"copyright"},{default:a(()=>[t(Q,null,{default:a(()=>[u(r(e.t("landing_page.ccbync")),1)]),_:1})]),_:1})):v("",!0)])]),d("h1",Bn,r(e.selectModelName),1),d("div",Ln,[d("div",Sn,r(e.t(`embedding.${e.selectModelName.replace(".","")}_description`)),1),e.selectedModel.metadata.release_blog?(o(),g(V,{key:0,flat:"",label:e.t("models.metadata.release_blog"),square:"",to:e.selectedModel.metadata.release_blog,"icon-right":"arrow_forward",class:"col-auto bg-mixed-200",target:"_blank"},null,8,["label","to"])):v("",!0)])]}),_:1}),t(X,null,{default:a(()=>{var n;return[d("div",Rn,[d("div",Pn,r(e.t("models.metadata.license")),1),t(W,{icon:e.ccncOptions.includes(e.selectModelName)?"copyright":"license",style:{"border-radius":"0"},size:"sm",class:"bg-mixed-200",color:"transparent",label:e.selectedModel.metadata.license},null,8,["icon","label"])]),d("div",Gn,[d("div",Jn,r(e.t("models.metadata.release_date")),1),t(W,{icon:"calendar_month",style:{"border-radius":"0"},size:"sm",class:"bg-mixed-200",color:"transparent",label:e.selectedModel.metadata.release_date},{default:a(()=>[t(Q,null,{default:a(()=>[u(r(e.t("models.metadata.release_date")),1)]),_:1})]),_:1},8,["label"])]),d("div",On,[d("div",Wn,r(e.t("models.sections.model_details")),1),(o(!0),h(I,null,L(e.modelDetails,c=>(o(),g(W,{key:c.key,style:{"border-radius":"0"},size:"sm",class:"bg-mixed-200"},{default:a(()=>[u(r(e.t(`models.sections.${c.key}`))+": "+r(c.value),1)]),_:2},1024))),128))]),(n=e.selectedModel.metadata.language)!=null&&n.length?(o(),h("div",Fn,[d("div",Un,r(e.t("models.sections.language_support")),1),(o(!0),h(I,null,L(e.selectedModel.metadata.language,c=>(o(),g(W,{square:"",style:{"border-radius":"0"},size:"sm",key:c,class:"bg-mixed-200"},{default:a(()=>[u(r(`${e.langcode2SingleEmoji(c)} ${e.mapLangCodeToLanguageName(c)}`),1)]),_:2},1024))),128))])):v("",!0),e.selectedModel.metadata.related_models&&e.selectedModel.metadata.related_models.length?(o(),h("div",Nn,[d("div",Dn,r(e.t("models.metadata.related_models")),1),(o(!0),h(I,null,L(e.selectedModel.metadata.related_models,c=>(o(),g(W,{clickable:"",square:"",key:c,class:"bg-mixed-200",size:"sm",style:{"border-radius":"0"},onClick:q=>e.selectModel(c),icon:"link"},{default:a(()=>[u(r(c),1)]),_:2},1032,["onClick"]))),128))])):v("",!0),d("div",Hn,[d("div",Qn,r(e.t("models.sections.tags")),1),(o(!0),h(I,null,L(e.selectedModel.metadata.tags,c=>(o(),g(W,{size:"sm",style:{"border-radius":"0"},key:c,class:"bg-mixed-200"},{default:a(()=>[u(r(c),1)]),_:2},1024))),128))])]}),_:1}),t(X,{class:"row q-col-gutter-sm"},{default:a(()=>[d("div",Kn,r(e.t("models.sections.using_model")),1),(o(!0),h(I,null,L(e.availableExternalLinks,n=>(o(),g(V,{"no-caps":"",flat:"",icon:n.icon,label:e.t(`models.metadata.${n.key}_link`),key:n.key,square:"",class:"ellipsis",href:n.link.startsWith("http")?n.link:void 0,to:n.link.startsWith("http")?void 0:n.link,target:"_blank"},null,8,["icon","label","href","to"]))),128))]),_:1})]),_:1}),t(e.ResearchersComponent,{"model-name":e.selectModelName},null,8,["model-name"]),t(A,{src:e.selectedModel.content,"copy-icon":"content_copy",class:"gh-content q-mt-xl","no-line-numbers":"","no-heading-anchor-links":""},null,8,["src"]),d("div",Vn,r(e.t("models.sections.blogs")),1),t(e.NewsFilterComponent,{initiating:e.initiating,"translated-all-blogs":e.translatedAllBlogs,"search-by-title":e.selectModelName,"per-page":5},null,8,["initiating","translated-all-blogs","search-by-title"])],64)):(o(),h("div",Yn,r(e.t("models.select_model")),1))])],2)]),_:1})}const ya=Re(kn,[["render",Xn],["__file","ModelsPage.vue"]]);export{ya as default};
