...
`,Q=R({__name:"LegalPage",setup(e,{expose:o}){o();const l=j(),{t}=q(),h=()=>{var a;(a=window.print)==null||a.call(window)};H({page:"legal_page",url:"legal",banner:"banner.png"});const c={route:l,t,print:h,get LEGAL_SECTIONS(){return M},get locateByHash(){return O},get legalMd(){return V}};return Object.defineProperty(c,"__isScriptSetup",{enumerable:!1,value:!0}),c}}),$={class:"row justify-center q-py-xl q-my-xl"},K={class:"col-12"},X={class:"row q-my-xl justify-center print-hide"},Z={class:"col-11 col-sm-10 col-md-8 col-lg-7 col-xl-6 q-gutter-y-xl"},ee={class:"row print-hide q-gutter-xs"},te={class:"row justify-center"},oe={class:"col-10 col-md-8 col-lg-7 col-xl-6"},ae={class:"content q-my-xl q-py-xl"};function ie(e,o,l,t,h,c){const a=U("q-markdown");return m(),y(W,null,{default:b(()=>[s("div",$,[s("div",K,[s("div",X,[s("div",Z,[s("div",ee,[d(f,{outline:"",icon:"print",label:t.t("print"),onClick:o[0]||(o[0]=i=>t.print()),square:"","no-wrap":""},null,8,["label"]),d(f,{outline:"",label:t.t("legal_page.download_type1"),target:"_blank",href:"/Jina_AI_GmbH_Letter_of_Attestation_SOC_2_Type_1.pdf",square:"","no-wrap":"",icon:"download"},null,8,["label"]),d(f,{outline:"",label:t.t("legal_page.download_type2"),target:"_blank",href:"/Jina AI GmbH_Letter of Attestation SOC 2 Type 2.pdf",square:"","no-wrap":"",icon:"download"},null,8,["label"]),d(f,{outline:"",label:t.t("legal_page.request_audit"),target:"_blank",to:"/contact-sales",square:"","no-wrap":"",icon:"policy"},null,8,["label"])]),d(z,null,{default:b(()=>[(m(!0),_(L,null,E(t.LEGAL_SECTIONS,i=>(m(),y(Y,{key:i.label,label:i.label,onClick:n=>t.locateByHash(i.link),class:"cursor-pointer"},null,8,["label","onClick"]))),128))]),_:1})])]),s("div",te,[s("div",oe,[s("div",ae,[d(a,{src:t.legalMd,"no-heading-anchor-links":"","no-linkify":"",html:!0},null,8,["src"])])])])])])]),_:1})}const le=F(Q,[["render",ie],["__scopeId","data-v-10499857"],["__file","LegalPage.vue"]]);export{le as default};
