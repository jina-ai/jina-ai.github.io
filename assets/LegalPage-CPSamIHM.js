import{s as w,d7 as T,dg as S,m as p,p as u,ao as P,b6 as k,dh as D,di as G,cc as x,K as J,j as q,a0 as R,b1 as _,am as O,a2 as j,a3 as g,a4 as y,a5 as b,a8 as s,a6 as h,q as f,aa as F,ai as E,ah as L,b8 as U}from"./index-CRz4LoPx.js";import{Q as W}from"./QPage-Ca-uhj3E.js";import{u as H}from"./useMetaTags-QdZvHcBg.js";import"./package-D9JPNs5w.js";const B=w({name:"QBreadcrumbsEl",props:{...T,label:String,icon:String,tag:{type:String,default:"span"}},emits:["click"],setup(e,{slots:o}){const{linkTag:l,linkAttrs:t,linkClass:d,navigateOnClick:c}=S(),n=p(()=>({class:"q-breadcrumbs__el q-link flex inline items-center relative-position "+(e.disable!==!0?"q-link--focusable"+d.value:"q-breadcrumbs__el--disable"),...t.value,onClick:c})),a=p(()=>"q-breadcrumbs__el-icon"+(e.label!==void 0?" q-breadcrumbs__el-icon--with-label":""));return()=>{const i=[];return e.icon!==void 0&&i.push(u(P,{class:a.value,name:e.icon})),e.label!==void 0&&i.push(e.label),u(l.value,{...n.value},k(o.default,i))}}}),Y=["",!0],z=w({name:"QBreadcrumbs",props:{...D,separator:{type:String,default:"/"},separatorColor:String,activeColor:{type:String,default:"primary"},gutter:{type:String,validator:e=>["none","xs","sm","md","lg","xl"].includes(e),default:"sm"}},setup(e,{slots:o}){const l=G(e),t=p(()=>`flex items-center ${l.value}${e.gutter==="none"?"":` q-gutter-${e.gutter}`}`),d=p(()=>e.separatorColor?` text-${e.separatorColor}`:""),c=p(()=>` text-${e.activeColor}`);return()=>{if(o.default===void 0)return;const n=x(J(o.default));if(n.length===0)return;let a=1;const i=[],v=n.filter(r=>r.type!==void 0&&r.type.name==="QBreadcrumbsEl").length,A=o.separator!==void 0?o.separator:()=>e.separator;return n.forEach(r=>{if(r.type!==void 0&&r.type.name==="QBreadcrumbsEl"){const m=a<v,I=r.props!==null&&Y.includes(r.props.disable),C=(m===!0?"":" q-breadcrumbs--last")+(I!==!0&&m===!0?c.value:"");a++,i.push(u("div",{class:`flex items-center${C}`},[r])),m===!0&&i.push(u("div",{class:"q-breadcrumbs__separator"+d.value},A()))}else i.push(r)}),u("div",{class:"q-breadcrumbs"},[u("div",{class:t.value},i)])}}}),N=`# Legal Information
...
`,M=q({__name:"LegalPage",setup(e,{expose:o}){o();const l=O(),{t}=R(),d=()=>{var n;(n=window.print)==null||n.call(window)};H({page:"legal_page",url:"legal",banner:"banner.png"});const c={route:l,t,print:d,get locateByHash(){return _},get legalMd(){return N}};return Object.defineProperty(c,"__isScriptSetup",{enumerable:!1,value:!0}),c}}),V={class:"row justify-center q-py-xl q-my-xl"},Q={class:"col-12"},$={class:"row q-my-xl justify-center print-hide"},K={class:"col-11 col-sm-10 col-md-8 col-lg-7 col-xl-6 q-gutter-y-xl"},X={class:"row print-hide q-gutter-xs"},Z={class:"row justify-center"},ee={class:"col-10 col-md-8 col-lg-7 col-xl-6"},te={class:"content q-my-xl q-py-xl"};function oe(e,o,l,t,d,c){const n=U("q-markdown");return g(),y(W,null,{default:b(()=>[s("div",V,[s("div",Q,[s("div",$,[s("div",K,[s("div",X,[h(f,{outline:"",icon:"print",label:t.t("print"),onClick:o[0]||(o[0]=a=>t.print()),square:"","no-wrap":""},null,8,["label"]),h(f,{outline:"",label:t.t("legal_page.download_type1"),target:"_blank",href:"/Jina_AI_GmbH_Letter_of_Attestation_SOC_2_Type_1.pdf",square:"","no-wrap":"",icon:"download"},null,8,["label"]),h(f,{outline:"",label:t.t("legal_page.download_type2"),target:"_blank",href:"/Jina AI GmbH_Letter of Attestation SOC 2 Type 2.pdf",square:"","no-wrap":"",icon:"download"},null,8,["label"]),h(f,{outline:"",label:t.t("legal_page.request_audit"),target:"_blank",to:"/contact-sales",square:"","no-wrap":"",icon:"policy"},null,8,["label"])]),h(z,null,{default:b(()=>[(g(!0),F(L,null,E(e.LEGAL_SECTIONS,a=>(g(),y(B,{key:a.label,label:a.label,onClick:i=>t.locateByHash(a.link),class:"cursor-pointer"},null,8,["label","onClick"]))),128))]),_:1})])]),s("div",Z,[s("div",ee,[s("div",te,[h(n,{src:t.legalMd,"no-heading-anchor-links":"","no-linkify":"",html:!0},null,8,["src"])])])])])])]),_:1})}const se=j(M,[["render",oe],["__scopeId","data-v-87b2c683"],["__file","LegalPage.vue"]]);export{se as default};
